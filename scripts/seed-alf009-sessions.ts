...
const SEED = {
  ...
  visionStage: [
    { title: '02 Opening Session', day: '2026-08-10', start: '09:30', end: '11:00', room: 'Vision Stage' },
    { title: '04 Women of ALPFA Luncheon', day: '2026-08-10', start: '12:30', end: '14:00', room: 'Vision Stage' },
    { title: '07 Awards Ceremony', day: '2026-08-10', start: '19:00', end: '20:30', room: 'Vision Stage' },
    { title: '12 Gala - Legacy by Design', day: '2026-08-11', start: '19:00', end: '21:00', room: 'Vision Stage' },
    { title: '15 ALPFA Scholarship Ceremony (Invite Only)', day: '2026-08-12', start: '12:00', end: '13:30', room: 'Vision Stage' },
  ] satisfies SeedEntry[],
  exchangeStage: [
    { title: 'Deloitte Accounting for You', day: '2026-08-09', start: '12:00', end: '15:00', room: 'Exchange Stage' },
    { title: '03 PP Workshop 1: Innovation at the Intersection of Science, Technology, and Human Impact', day: '2026-08-10', start: '11:30', end: '12:30', room: 'Exchange Stage' },
    { title: '06 Market Dynamics and Growth Engines: A forward look at U.S. Economic Growth', day: '2026-08-10', start: '15:30', end: '16:30', room: 'Exchange Stage' },
    { title: '09 WOA Workshop 1: the three high impact conversations that accelerate early career', day: '2026-08-11', start: '11:00', end: '12:00', room: 'Exchange Stage' },
    { title: '11 PP Workshop 2: harnessing disruption: turning change into enterprise strategy', day: '2026-08-11', start: '15:00', end: '16:00', room: 'Exchange Stage' },
    { title: '13 PwC - Powerful Perspectives', day: '2026-08-12', start: '10:00', end: '10:30', room: 'Exchange Stage' },
    { title: '14 WOA Workshop 2: the power of strategic visibility and storytelling', day: '2026-08-12', start: '12:00', end: '13:00', room: 'Exchange Stage' },
    { title: '16 Convention Closing Session: Elevating the Momentum. Embodying the Future.', day: '2026-08-12', start: '15:30', end: '16:30', room: 'Exchange Stage' },
  ] satisfies SeedEntry[],
